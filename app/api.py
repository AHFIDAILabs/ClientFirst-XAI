...
# # Define the mapping from Likert scale text to numeric score
# LIKERT_MAPPING = {
#     "Strongly Disagree": 1.0,
#     "Disagree": 2.0,
#     "Neither Agree Or Disagree": 3.0,
#     "Agree": 4.0,
#     "Strongly Agree": 5.0
# }
...
#     Care_Duration_Years: float = Field(..., ge=0.0, description="Years at this facility")
#     Facility_Care_Dur_Years: float = Field(..., ge=0.0, description="Total years in HIV care across all facilities")
#     Empathy_Score: str = Field(..., description="Provider Empathy Score (Likert scale)")
#     Listening_Score: str = Field(..., description="Provider Listening Score (Likert scale)")
#     Decision_Share_Score: str = Field(..., description="Shared Decision-Making Score (Likert scale)")
#     Exam_Explained: str = Field(..., description="Provider explained exams/procedures clearly (Likert scale)")
#     Discuss_NextSteps: str = Field(..., description="Provider discussed the next steps in my care (Likert scale)")
...
#                     "Facility_Care_Dur_Years": 5.0,
#                     "Empathy_Score": "Agree",
#                     "Listening_Score": "Agree",
#                     "Decision_Share_Score": "Neither Agree Or Disagree",
#                     "Exam_Explained": "Agree",
#                     "Discuss_NextSteps": "Agree"
#                 }
#             ]
...
#         # Map Likert scale text to numeric scores for the model
#         for score_key in ["Empathy_Score", "Listening_Score", "Decision_Share_Score"]:
#             if score_key in raw_inputs_dict:
#                 likert_value = raw_inputs_dict[score_key]
#                 if likert_value not in LIKERT_MAPPING:
#                     raise ValueError(f"Invalid Likert scale value for {score_key}: {likert_value}")
#                 raw_inputs_dict[score_key] = LIKERT_MAPPING[likert_value]
